...
1. Intersect each replicate interval file with protein_coding_genes.bed and unique_exons.bed
...
# BED file containing all unique protein-coding exons in the S. purpuratus reference genome assembly 
exon_file = "/hb/home/mglasena/dissertation/scripts/phylonet_hmm/genome_metadata/unique_exons.bed"
