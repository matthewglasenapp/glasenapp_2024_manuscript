...
genotype_calls = "/hb/scratch/mglasena/dxy/combined_vcf_files/genotype_calls.g.vcf.gz"
genotype_calls_split_multiallelics = "/hb/scratch/mglasena/dxy/combined_vcf_files/genotype_calls_split_multiallelics.g.vcf.gz"
