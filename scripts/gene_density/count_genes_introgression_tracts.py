...
replicate_interval_file_dir = "/hb/scratch/mglasena/phylonet_hmm/process_hmm_90/gene_density/introgression_tracts/replicate_interval_files/"
...
output_directory_CDS = "/hb/scratch/mglasena/phylonet_hmm/process_hmm_90/gene_density/introgression_tracts/bedtools_intersect_dir_CDS/"
...
def main():
	...
	# Intersect each replicate interval file with unique_CDS.bed
	...
	# Populate count_CDS_dict with each replicate interval file and the number of overlapping coding bases
	...
	write_to_csv(count_bases_dict, "count_bases.csv")
